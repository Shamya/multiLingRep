...
def multilingualcorpus(mode,ENG_sentences,ESP_sentences):
    ...
    if mode=="Save":
        ...
        multilingual_data= transform(ENG_sentences,'english') + transform(ESP_sentences, 'spanish')
        # Random shuffle of the sentences
        ...
        # Writing JSON data
        with open('multidata_ita_eng.json', 'w') as f:
...
embeddings(ESP_sentences,[],multilingual_data)
corpus_stats()
