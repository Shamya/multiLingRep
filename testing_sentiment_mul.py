...
print "Trained on English , Tested on English"
...
print "Trained on spanish , Tested on Spanish"
...
print "Trained on spanish , Tested on English"
train_df = train_spanish_df
test_df = entire_english_df
print "Length of Train : ", str(len(train_df))
print "Length of Test : ", str(len(test_df))
classifyusingAvgVectors(train_df,test_df,dimensionOfVector=300, model=en_es_model)


print "Trained on English , Tested on Spanish"
train_df = entire_english_df
test_df = train_spanish_df
print "Length of Train : ", str(len(train_df))
print "Length of Test : ", str(len(test_df))
classifyusingAvgVectors(train_df,test_df,dimensionOfVector=300, model=en_es_model)
...
print "Trained on spanish+english , Tested on Spanish"
train_df = es_en_train_df
test_df = test_spanish_df
print "Length of Train : ", str(len(train_df))
print "Length of Test : ", str(len(test_df))
classifyusingAvgVectors(train_df,test_df,dimensionOfVector=300, model=en_es_model)
...
print "Trained on spanish+english , Tested on English"
train_df = es_en_train_df
test_df = test_english_df
print "Length of Train : ", str(len(train_df))
print "Length of Test : ", str(len(test_df))
...
print "Trained on spanish+english , Tested on English+spanish"
train_df = es_en_train_df
test_df = es_en_test_df
print "Length of Train : ", str(len(train_df))
print "Length of Test : ", str(len(test_df))
classifyusingAvgVectors(train_df,test_df,dimensionOfVector=300, model=en_es_model)
...
print "Trained on English + Spanish Tested on English"
train_df = es_en_train_df
test_df = test_english_df
print "Length of Train : ", str(len(train_df))
print "Length of Test : ", str(len(test_df))
