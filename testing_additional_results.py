...
print "Trained on En , Tested on En -EXP # 4"
...
print "Trained on Spanish , Tested on Spanish-EXP # 20"
...
print "Trained on spanish+english+Italian, Tested on Spanish -EXP # 31"
...
print "Trained on English , Tested on Italian - Exp # 34"
train_df = train_english_df
...
print "Trained on Spanish , Tested on Italian - Exp # 35"
train_df = train_spanish_df
test_df = test_italian_df
print "Length of Train : ", str(len(train_df))
print "Length of Test : ", str(len(test_df))
...
print "Trained on English , Tested on Italian - Exp # 38"
train_df = train_english_df
test_df = test_italian_df
print "Length of Train : ", str(len(train_df))
print "Length of Test : ", str(len(test_df))
...
print "Trained on spanish , Tested on Italian - Exp # 39"
train_df = train_spanish_df
test_df = test_italian_df
print "Length of Train : ", str(len(train_df))
print "Length of Test : ", str(len(test_df))
